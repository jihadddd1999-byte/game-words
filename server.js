...
const words = [
  ...
  "قمر","نهر","جبل","مطر","نوم","سلامييي","بطيخ","صديق","سعادة","ليل",
  ...
  "ثلج","رياح","غيمة","صوت","رائحة","لون","طعم","ايرين عمك","شعور","ذاكرة",
  "حلم","ذكريات","كتاب","مكتبة","مكتوب","لغة","كهرباء","ضوء","كول","ظل",
  "لولو","حرام ايرين يموت قهر","برد","حار","رمل","صابون","زيت","سكر","ملح","فلفل",
